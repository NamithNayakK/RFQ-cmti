    ...
    <div className="flex-1 flex flex-col bg-slate-50 h-screen overflow-hidden">
      ...
      <div className="bg-white border-b border-slate-200 px-8">
        <div className="flex gap-6">
          {[
            { value: 'materials', label: '💰 Material Pricing' },
            { value: 'settings', label: '⚙️ Quote Settings' },
            { value: 'calculator', label: '🧮 Quote Calculator' },
          ].map((tab) => (
            <button
              key={tab.value}
        ...
        {activeTab === 'calculator' && (
          <div className="max-w-3xl">
            <div className="bg-white rounded-lg border border-slate-200 p-8">
              ...
              <p className="text-slate-600 mb-6">Use this calculator to quickly estimate quotation amounts based on your materials and settings.</p>
